module "k8s-control-plane" {
  ...
  control_planes_user_assigned_identity_id        = var.control_planes_user_assigned_identity_id
  control_planes_user_assigned_identity_client_id = var.control_planes_user_assigned_identity_client_id
...
module "k8s-worker-nodes" {
  ...
  kv_uri                                        = var.kv_uri
  kv_name                                       = var.kv_name
  worker_nodes_user_assigned_identity_id        = var.worker_nodes_user_assigned_identity_id
  worker_nodes_user_assigned_identity_client_id = var.worker_nodes_user_assigned_identity_client_id
  subscription_id                               = var.subscription_id
  k8s_base_node_image_id = var.k8s_base_node_image_id
}
