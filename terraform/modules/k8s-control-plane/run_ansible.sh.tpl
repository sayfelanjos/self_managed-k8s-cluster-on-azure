...
ansible-playbook -i ansible/inventories/hosts/hosts.ini --connection=local  ansible/install_control_plane.yaml --extra-vars "control_plane_endpoint=${control_plane_endpoint}"