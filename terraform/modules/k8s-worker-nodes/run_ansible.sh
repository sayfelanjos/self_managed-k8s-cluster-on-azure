...
git clone --depth 1 --filter=blob:none https://github.com/sayfelanjos/self_managed-k8s-cluster-on-azure /tmp/k8s-worker-node-setup
cd /tmp/k8s-worker-node-setup
